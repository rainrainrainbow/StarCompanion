...
export const lightColors: TokenColors = {
  ...
  userAvatarNameColors: [LIGHT_PRIMARY, LIGHT_SECONDARY, LIGHT_TERTIARY, LIGHT_ERROR],
...
export const darkColors: TokenColors = {
  ...
  userAvatarImageBackground: 'transparent',
  userAvatarNameColors: [DARK_PRIMARY, DARK_SECONDARY, DARK_TERTIARY, DARK_ERROR],
